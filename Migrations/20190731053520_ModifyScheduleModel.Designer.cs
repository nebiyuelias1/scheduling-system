...
namespace SchedulingSystem.Migrations
{
    ...
    [Migration("20190731053520_ModifyScheduleModel")]
    partial class ModifyScheduleModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchedulingSystem.Core.Models.DaySchedule", b =>
                {
                    b.HasOne("SchedulingSystem.Core.Models.Schedule")
                        .WithMany("TimeTable")
                        .HasForeignKey("ScheduleId");
            ...
            modelBuilder.Entity("SchedulingSystem.Core.Models.DaySession", b =>
                {
                    b.HasOne("SchedulingSystem.Core.Models.DaySchedule")
            ...
            modelBuilder.Entity("SchedulingSystem.Core.Models.ScheduleEntry", b =>
                {
                    ...
                    b.HasOne("SchedulingSystem.Core.Models.Day")
                        .WithMany("Periods")
                        .HasForeignKey("DayId");
