...
namespace SchedulingSystem.Migrations
{
    ...
    [Migration("20190131113253_RenameRoomTypesToTypes")]
    partial class RenameRoomTypesToTypes
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SchedulingSystem.Models.Schedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SchedulingSystem.Models.ScheduleEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("SchedulingSystem.Models.ScheduleEntry", b =>
                {
                    ...
                    b.HasOne("SchedulingSystem.Models.Day", "Day")
                        .WithMany("Periods")
                        .HasForeignKey("DayId")
                        .OnDelete(DeleteBehavior.Cascade);
